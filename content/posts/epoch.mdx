...
<figure>
  ...
  <figcaption>Seems like it's easy to invalidate myself sometimes. I have no idea what I'm doing; how <i>can</i> I help?</figcaption>
</figure>
...
<figure>
  ...
  />
  <figcaption>At one point in time, I was <i>really</i> into it.</figcaption>
</figure>
...
This was where I felt really challenged and the ['screw it' mentality](/posts/2022-in-review#gaining-more-self-confidence-to-try-new-things) really kicked in when I ended up scheduling emails to be sent out at a certain time. I'd ignore my inbox (as bad as that was) for an hour or two then check for a response afterwards. I eventually got the hang of it, even scheduling a video call with someone to hear their idea more (that was wild looking back!).
...
<figure>
  ...
  />
  <figcaption>There was an endless loop of output, recommendation, and then alteration without stopping.</figcaption>
</figure>
...
<figure>
  ...
  />
  <figcaption>The first time I'd been in a departure lounge alone. I can't remember what it was like the last time I was here!</figcaption>
</figure>
...
<figure class="images">
  ...
  <figure>
    ...
    />
    <figcaption>The departure hall of Kuala Lumpur International Airport. It looks really neat.</figcaption>
  </figure>
  <figure>
    <img
...
<figure class="images">
  ...
  <figure>
    ...
    />
    <figcaption>Landing in New Delhi's Indira Gandhi International Airport.</figcaption>
  </figure>
</figure>
...
<figure class="images">
  ...
  <figcaption>Three of the few originally-planned designated rooms for workshops.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Tofu burger! Looking at it now makes me hungry for it again.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>A few of us watching The Murder on the Orient Express.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Most members of the Epoch organising team at a pretty fancy-schmancy hotel.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>A picture of Aaryan and me. I'm super super grateful to him for taking good care of me on the final day and making sure I make it to the airport safe and sound!</figcaption>
</figure>
...
<figure class="images">
  <figure>
    ...
    <figcaption>The entrance to Indira Gandhi International Airport's departure hall.</figcaption>
  </figure>
  <figure>
    <img src="/images/epoch/024.jpg" />
    <figcaption>A pretty cool picture of the cabin while flying at night.</figcaption>
  </figure>
</figure>

<figure>
  <img src="/images/epoch/025.jpg" />
  <figcaption>The night sky, with some colour distortions from the cabin.</figcaption>
</figure>
