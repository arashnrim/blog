...
<figure>
  ...
  <figcaption>One of my Shortcuts workflows that runs at 5:00 a.m.</figcaption>
</figure>
...
<figure>
  ...
  />
  <figcaption>Experimenting with n8n, where I tried playing with webhooks.</figcaption>
</figure>
...
<figure>
  ...
  />
  <figcaption>Adding an LLM into the workflow is as simple as a dropping in a node.</figcaption>
</figure>
...
<figure>
  ...
  />
  <figcaption>I was confused for a bit — how was I going to combine these two LLM providers together if their response schema are different?</figcaption>
</figure>
...
<figure>
  ...
  />
  <figcaption>Everything put together in the graph looks so satisfying.</figcaption>
</figure>
...
<figure>
  ...
  />
  <figcaption>Everything condensed into just three nodes in Shortcuts.</figcaption>
</figure>
