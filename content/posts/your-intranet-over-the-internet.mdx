...
<figure>
  ...
  />
  <figcaption>
    My network as it is now. If I'm out and about out of my home network, I'm
    not able to access my devices at home.
  </figcaption>
</figure>
...
<figure>
  ...
  />
  <figcaption>
    With Tailscale, whether I'm in the same network or not, all my devices are
    connected to each other. W for me.
  </figcaption>
</figure>
